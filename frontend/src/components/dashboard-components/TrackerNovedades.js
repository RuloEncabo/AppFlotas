...
const data = [
  {
    subtitle: '142',
    title: 'Novedades nuevas',
    avatarIcon: 'tabler:ticket'
  },
  {
    subtitle: '28',
    avatarColor: 'info',
    title: 'Novedades resueltas',
      ...
      <CardContent>
        <Grid container spacing={6}>
          <Grid item xs={12} sm={5}>
            ...
            <Typography sx={{ mb: 6, color: 'text.secondary' }}>Total Novedades</Typography>
            {data.map((item, index) => (
              <Box
                key={index}
...
export default TrackerNovedades
